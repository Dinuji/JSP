	...
	if($qty20!=0 or $qty20!=NULL){
		...
		if($row20==1){
			...
			for($r20=(int)$start20;$r20<=(int)$end20;$r20++){
				$queryDelete20="delete from fsecardstock where fseid='$fseid' and serialNo='$r20' ";
	...
	if($qty50!=0 or $qty50!=NULL){
		...
		if($row50==1){
			...
			for($r50=(int)$start50;$r50<=(int)$end50;$r50++){
				$queryDelete50="delete from fsecardstock where fseid='$fseid' and serialNo='$r50' ";
	...
	if($qty100!=0 or $qty100!=NULL){
		...
		if($row100==1){
			...
			for($r100=(int)$start100;$r100<=(int)$end100;$r100++){
				$queryDelete100="delete from fsecardstock where fseid='$fseid' and serialNo='$r100' ";
	...
	if($qty500!=0 or $qty500!=NULL){
		...
		if($row500==1){
			...
			for($r500=(int)$start500;$r500<=(int)$end500;$r500++){
				$queryDelete500="delete from fsecardstock where fseid='$fseid' and serialNo='$r500' ";
	...
	if($qty1000!=0 or $qty1000!=NULL){
		...
		if($row1000==1){
			...
			for($r1000=(int)$start1000;$r1000<=(int)$end1000;$r1000++){
				$queryDelete1000="delete from fsecardstock where fseid='$fseid' and serialNo='$r1000' ";
