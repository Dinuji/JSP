...
<center>
 	...
 	<br>
	<div class="h2div" >My Stock Summery</div>
	<br>
...
?>
    ...
    <br>
  <div class="h2div" >My Reloads</div>
  <br>
  ...
  $sql="select * from reload_transferred_stock where FseId=$id";
...
if($result){
  while($data=mysql_fetch_array($result)){
    ...
    if($id==$fseid){
      echo '<h2> Remaining Amount:'.$amount.'</h2>';
    }
...
<!------------------------------------------------------------------------------------------------>
    ...
    <br>
	<div class="h2div" >My Stock Dedails</div>
	<br>
